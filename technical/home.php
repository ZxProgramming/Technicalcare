...
$name = $_SESSION['technical']['firstName'] . " " . $_SESSION['technical']['lastName']
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn"><?php echo $name ?> </h1>
                    <a href="home.php" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="../profile.php" class="h5 text-white">Profile</a>
                </div>
            </div>
        </div>
    </div>
