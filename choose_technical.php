        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="text-light"><i class="bi bi-person-circle"></i> <?php echo $_SESSION['client']['email'] ?></small>
                </div>
            </div>
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="wait.php"><i class="bi bi-person-badge"></i></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="tm-gallery-page-السباكه" class="tm-gallery-page">
            ...
            foreach ($data as $data_technical) :
                echo "<div class='card1 tech_id' id='data-jason tech_id' style='width: 18rem;'>
                                    ...
                                    <div class='wrapper'>
                                            <div class='banner-image'> <img  src='$data_technical[image]' width=100%></div>
                            ...
                            <div class='button-wrapper'>
                                         <button class='add btn_card  button-wrapper' client_id='$data_client[id]' data-id='$data_technical[id]'>طلب فني</button>
                                        <button data-id='$data_technical[id]' class=' btn_card  button-wrapper  view_btn'>Information</button>
                                </div>
                            </div>
                        </div>
        ...
        <div id="tm-gallery-page-الكهرباء" class="tm-gallery-page hidden">
            ...
            foreach ($data as $data_technical) :
                echo "<div class='card1 tech_id' id='data-jason tech_id' style='width: 18rem;'>
                                                <div class='container_card'>
                                    <div class='wrapper'>
                                            <div class='banner-image'> <img src='$data_technical[image]' ></div>
                                            <h6 class='card-title'>$data_technical[type_of]</h6>
                                            <h5 class='card-title'>$data_technical[firstName]</h5>
                                            <p class='card-text'>$data_technical[email]</p>
                         </div>
